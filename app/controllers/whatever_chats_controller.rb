class WhateverChatsController < ApplicationController
  ...
  def index
    ...
    @whatever_chats = WhateverChat.where(to_user_id: 0).paginate(page: params[:page], per_page:100).order('whatever_chats.created_at DESC')
  ...
  def to_me
    ...
    @whatever_chats = WhateverChat.where(to_user_id: user_id).paginate(page: params[:page], per_page:100).order('created_at DESC')
    @whatever_chat = WhateverChat.new
    render 'index'
  end
  ...
  def from
    ...
    @whatever_chats = WhateverChat.where(from_user_id: username).paginate(page: params[:page], per_page:100).order('created_at DESC')
    @whatever_chat = WhateverChat.new
